...
def procesar_fila(client, fila):
    db = client.tp4
    coll = db.deportistas
    query = {"_id": fila["id_deportista"]}
    document = {"_id": fila["id_deportista"], "nombre": fila["nombre_deportista"], "fecha_nacimiento": fila["fecha_nacimiento"], "id_pais_deportista": fila["id_pais_deportista"], "nombre_pais_deportista": fila["nombre_pais_deportista"]}
